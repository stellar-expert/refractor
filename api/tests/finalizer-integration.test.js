...
const {setCallbackHandler} = require('../business-logic/finalization/callback-handler')
const {fakeSubmitTransaction} = require('../business-logic/rpc-connector')
...
test('high-level finalizer logic', async () => {
    ...
    await new Promise(resolve => {
        ...
        fakeSubmitTransaction(txInfo => new Promise(resolve => {
